...
function G(a,b,d){function c(){const c=a.unboundExports;g===b&&(g=e(b,[...d]));const l=[];Array.prototype.slice.call(arguments).forEach((a,b)=>{let d=void 0;g.shouldCacheTypes&&g.cachedArgTypes[b]&&"ref"===g.cachedArgTypes[b].type?d=F[g.cachedArgTypes[b].key]:Object.keys(F).some(e=>F[e].isTypeFromReference(c,a)?(d=F[e],g.shouldCacheTypes&&(g.cachedArgTypes[b]={type:"ref",key:e}),!0):!1);d?l.push(d.getValueFromRef(c,a)):l.push(a)});return f.apply(null,l)}let e=(a,b)=>{a=a[b[0]];b.shift();return 0<
b.length?e(a,b):a},f=e(b,[...d]),g=b;c.shouldCacheTypes=!0;c.cachedArgTypes=[];return c}
...
{this.exports[a].shouldCacheTypes=!0})}disableExportFunctionTypeCaching(){Object.keys(this.exports).forEach(a=>{this.exports[a].shouldCacheTypes=!1})}enableImportFunctionTypeCaching(){I(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!0})}disableImportFunctionTypeCaching(){I(this.importObject,[],(a,b,d)=>{a[d].shouldCacheTypes=!1})}}let K={version:"0.1.2",instantiate:async(a,b)=>{let d=new J;await d._instantiate(a,b);return d}};export default K;var AsBind=K;export{AsBind};
